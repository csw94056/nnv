...
if isempty(S)
    fprintf('\nThe over-approximate star abstract-domain reach set does not reaches the unsafe region, P3 holds on N2_9');
else
    fprintf('\nThe over-approximate star abstract-domain reach set reaches the unsafe region, safety is unknown, P3 may be violated on N2_9');
end
...
S = R.intersectHalfSpace(unsafe_mat, unsafe_vec);
if isempty(S)
    fprintf('\nThe over-approximate AbsDom abstract-domain reach set does not reaches the unsafe region, P3 holds on N2_9');
else
    fprintf('\nThe over-approximate AbsDom abstract-domain reach set reaches the unsafe region, safety is unknown, P3 may be violated on N2_9');
end
...
if isempty(S)
    fprintf('\nThe over-approximate rstar abstract-domain with two predicate constraint reach set does not reaches the unsafe region, P3 holds on N2_9');
else
    fprintf('\nThe over-approximate rstar abstract-domain with two predicate constraint reach set reaches the unsafe region, safety is unknown, P3 may be violated on N2_9');
end
...
if isempty(S)
    fprintf('\nThe over-approximate rstar abstract-domain with three predicate constraint reach set does not reaches the unsafe region, P3 holds on N2_9');
else
    fprintf('\nThe over-approximate rstar abstract-domain with three predicate constraint reach set reaches the unsafe region, safety is unknown, P3 may be violated on N2_9');
end
