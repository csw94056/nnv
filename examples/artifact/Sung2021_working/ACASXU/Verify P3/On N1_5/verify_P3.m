load outputSet.mat;
load ACASXU_run2a_1_5_batch_2000.mat;
...
if isempty(S)
    fprintf('\nThe over-approximate star reach set does not reaches the unsafe region, P3 holds on N1_5');
else
    fprintf('\nThe over-approximate star reach set reaches the unsafe region, safety is unknown, P3 may be violated on N1_5');
end
...
S = R.intersectHalfSpace(unsafe_mat, unsafe_vec);
if isempty(S)
    fprintf('\nThe over-approximate zonotope reach set does not reaches the unsafe region, P3 holds on N1_5');
else
    fprintf('\nThe over-approximate zonotope reach set reaches the unsafe region, safety is unknown, P3 may be violated on N1_5');
end
...
if isempty(S)
    fprintf('\nThe over-approximate star abstract-domain reach set does not reaches the unsafe region, P3 holds on N1_5');
else
    fprintf('\nThe over-approximate star abstract-domain reach set reaches the unsafe region, safety is unknown, P3 may be violated on N1_5');
end
...
S = R.intersectHalfSpace(unsafe_mat, unsafe_vec);
if isempty(S)
    fprintf('\nThe over-approximate AbsDom abstract-domain reach set does not reaches the unsafe region, P3 holds on N1_5');
else
    fprintf('\nThe over-approximate AbsDom abstract-domain reach set reaches the unsafe region, safety is unknown, P3 may be violated on N1_5');
end
...
if isempty(S)
    fprintf('\nThe over-approximate rstar abstract-domain with two predicate constraint reach set does not reaches the unsafe region, P3 holds on N1_5');
else
    fprintf('\nThe over-approximate rstar abstract-domain with two predicate constraint reach set reaches the unsafe region, safety is unknown, P3 may be violated on N1_5');
end
...
if isempty(S)
    fprintf('\nThe over-approximate rstar abstract-domain with three predicate constraint reach set does not reaches the unsafe region, P3 holds on N1_5');
else
    fprintf('\nThe over-approximate rstar abstract-domain with three predicate constraint reach set reaches the unsafe region, safety is unknown, P3 may be violated on N1_5');
end
