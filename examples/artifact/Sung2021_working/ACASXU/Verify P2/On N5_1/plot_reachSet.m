...
R5_scaled = R5.affineMap(normalized_mat, normalized_vec); % over-approximate normalized reach set using absdom
R6_scaled = R6.affineMap(normalized_mat, normalized_vec); % over-approximate normalized reach set using rstar with two predicate constraints
R7_scaled = R7.affineMap(normalized_mat, normalized_vec); % over-approximate normalized reach set using  rstar with three predicate constraints
