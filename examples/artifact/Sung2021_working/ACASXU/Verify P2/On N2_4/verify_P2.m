...
parfor i=1:n
    ...
    if isempty(S)
        fprintf('\nThe %d^th star output set does not reaches the unsafe region, P2 holds', i);
    else
        fprintf('\nThe %d^th star output set reaches the unsafe region, P2 is violated', i);
        safe = safe + 1;
    end
end

if safe >= 1
    fprintf('\nP2 is violated on N2_4');
else
    fprintf('\nP2 holds on N2_4');
end
...
if isempty(S)
    fprintf('\nThe over-approximate star reach set does not reaches the unsafe region, P2 holds on N2_4');
else
    fprintf('\nThe over-approximate star reach set reaches the unsafe region, safety is unknown, P2 may be violated on N2_4');
end
...
if isempty(S)
    fprintf('\nThe over-approximate zonotope reach set does not reaches the unsafe region, P2 holds on N2_4');
else
    fprintf('\nThe over-approximate zonotope reach set reaches the unsafe region, safety is unknown, P2 may be violated on N2_4');
end
...
if isempty(S)
    fprintf('\nThe over-approximate star abstract-domain reach set does not reaches the unsafe region, P2 holds on N2_4');
else
    fprintf('\nThe over-approximate star abstract-domain reach set reaches the unsafe region, safety is unknown, P2 may be violated on N2_4');
end
...
S = R.intersectHalfSpace(unsafe_mat, unsafe_vec);
if isempty(S)
    fprintf('\nThe over-approximate AbsDom abstract-domain reach set does not reaches the unsafe region, P2 holds on N2_4');
else
    fprintf('\nThe over-approximate AbsDom abstract-domain reach set reaches the unsafe region, safety is unknown, P2 may be violated on N2_4');
end
...
if isempty(S)
    fprintf('\nThe over-approximate rstar abstract-domain with two predicate constraint reach set does not reaches the unsafe region, P2 holds on N2_4');
else
    fprintf('\nThe over-approximate rstar abstract-domain with two predicate constraint reach set reaches the unsafe region, safety is unknown, P2 may be violated on N2_4');
end
...
if isempty(S)
    fprintf('\nThe over-approximate rstar abstract-domain with three predicate constraint reach set does not reaches the unsafe region, P2 holds on N2_4');
else
    fprintf('\nThe over-approximate rstar abstract-domain with three predicate constraint reach set reaches the unsafe region, safety is unknown, P2 may be violated on N2_4');
end
...
save safety_checking_time.mat exact_star_safety_checking_time approx_star_safety_checking_time approx_zono_safety_checking_time approx_star_abs_dom_safety_checking_time approx_absdom_safety_checking_time approx_rstar_absdom_two_safety_checking_time approx_rstar_absdom_three_safety_checking_time