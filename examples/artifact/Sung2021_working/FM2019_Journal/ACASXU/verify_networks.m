...
N1 = 5;
N2 = 9;
% [Res, VT] = verify(N1,N2,3,'exact-star',8);
...
% save P3_star_abs_dom.mat Res VT;
% [Res, VT] = verify(N1,N2,3, 'absdom',1);
% save P3_absdom.mat Res VT;
[Res, VT] = verify(N1,N2,3, 'rstar-absdom-two',1);
save P3_rstar_absdom_two.mat Res VT;
[Res, VT] = verify(N1,N2,3, 'rstar-absdom-three',1);
save P3_rstar_absdom_three.mat Res VT;
[Res, VT] = verify(N1,N2,3, 'rstar-caseb-three',1);
save P3_rstar_caseb_three.mat Res VT;
Rb = Res;
[Res, VT] = verify(N1,N2,3, 'rstar-casec-three',1);
save P3_rstar_casec_three.mat Res VT;
Rc = Res;
[Res, VT] = verify(N1,N2,3, 'rstar-combo-three',1);
save P3_rstar_combo_three.mat Res VT;
%% verify P4
N1 = 5;
N2 = 9;
% [Res, VT] = verify(N1,N2,4,'exact-star',8);
...
% [Res, VT] = verify(N1,N2,4, 'absdom',1);
% save P4_absdom.mat Res VT;
[Res, VT] = verify(N1,N2,4, 'rstar-absdom-two',1);
save P4_rstar_absdom_two.mat Res VT;
[Res, VT] = verify(N1,N2,4, 'rstar-absdom-three',1);
save P4_rstar_absdom_three.mat Res VT;
[Res, VT] = verify(N1,N2,4, 'rstar-caseb-three',1);
save P3_rstar_caseb_three.mat Res VT;
Rb = Res;
[Res, VT] = verify(N1,N2,4, 'rstar-casec-three',1);
save P3_rstar_casec_three.mat Res VT;
Rc = Res;
[Res, VT] = verify(N1,N2,3, 'rstar-combo-three',1);
save P3_rstar_combo_three.mat Res VT;
...
function [safe, vt] = verifyNetwork(n1, n2, property_id, method, numCores)
    ...
    if strcmp(method, 'absdom')
        I = AbsDom(I);
    elseif strcmp(method, 'rstar-absdom-two') || strcmp(method, 'rstar-absdom-three') || strcmp(method, 'rstar-caseb-three') || strcmp(method, 'rstar-casec-three')
        I = RStar(I);
    end
...
function [F, I] = constructNetwork_inputSet(n1,n2,property_id)    
    addpath(genpath("../../../../nn/ffnn/ACASXU/"));
