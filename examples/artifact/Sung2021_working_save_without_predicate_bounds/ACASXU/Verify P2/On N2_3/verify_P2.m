...
if isempty(S)
    fprintf('\nThe over-approximate star reach set does not reaches the unsafe region, P2 holds on N2_3');
else
    fprintf('\nThe over-approximate star reach set reaches the unsafe region, safety is unknown, P2 may be violated on N2_3');
end
...
if isempty(S)
    fprintf('\nThe over-approximate zonotope reach set does not reaches the unsafe region, P2 holds on N2_3');
else
    fprintf('\nThe over-approximate zonotope reach set reaches the unsafe region, safety is unknown, P2 may be violated on N2_3');
end
...
if isempty(S)
    fprintf('\nThe over-approximate star abstract-domain reach set does not reaches the unsafe region, P2 holds on N2_3');
else
    fprintf('\nThe over-approximate star abstract-domain reach set reaches the unsafe region, safety is unknown, P2 may be violated on N2_3');
end
...
S = R.intersectHalfSpace(unsafe_mat, unsafe_vec);
if isempty(S)
    fprintf('\nThe over-approximate AbsDom abstract-domain reach set does not reaches the unsafe region, P2 holds on N2_3');
else
    fprintf('\nThe over-approximate AbsDom abstract-domain reach set reaches the unsafe region, safety is unknown, P2 may be violated on N2_3');
end
...
if isempty(S)
    fprintf('\nThe over-approximate rstar abstract-domain with two predicate constraint reach set does not reaches the unsafe region, P2 holds on N2_3');
else
    fprintf('\nThe over-approximate rstar abstract-domain with two predicate constraint reach set reaches the unsafe region, safety is unknown, P2 may be violated on N2_3');
end
...
if isempty(S)
    fprintf('\nThe over-approximate rstar abstract-domain with three predicate constraint reach set does not reaches the unsafe region, P2 holds on N2_3');
else
    fprintf('\nThe over-approximate rstar abstract-domain with three predicate constraint reach set reaches the unsafe region, safety is unknown, P2 may be violated on N2_3');
end
