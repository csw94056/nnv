...
% Load MNIST Data
trainX_full = loadMNISTImages('../train-images.idx3-ubyte');
...
layers = [ 
    ...
    sequenceInputLayer(784, 'Name', 'input', 'Normalization', 'rescale-zero-one')
	flattenLayer('Name', 'flatten')
	
	fullyConnectedLayer(500,'WeightsInitializer', 'glorot', 'Name', 'dense_1')
	sigmoidLayer('Name', 'sigmoid_1')
	
	fullyConnectedLayer(500,'WeightsInitializer', 'glorot', 'Name', 'dense_2')
	sigmoidLayer('Name', 'sigmoid_2')
    
    fullyConnectedLayer(500,'WeightsInitializer', 'glorot', 'Name', 'dense_3')
	sigmoidLayer('Name', 'sigmoid_3')
    
    fullyConnectedLayer(500,'WeightsInitializer', 'glorot', 'Name', 'dense_4')
	sigmoidLayer('Name', 'sigmoid_4')
    
    fullyConnectedLayer(500,'WeightsInitializer', 'glorot', 'Name', 'dense_5')
	sigmoidLayer('Name', 'sigmoid_5')
    
    fullyConnectedLayer(500,'WeightsInitializer', 'glorot', 'Name', 'dense_6')
...
save MNIST_sigmoid_100_100_normalized_DenseNet.mat net;
...
save images_normalized.mat IM_data IM_labels
