...
[r02, rb02, cE02, cands02, vt02] = nnv_net.evaluateRBN(A_eps_02(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon02 = [0.2];
...
[r04, rb04, cE04, cands04, vt04] = nnv_net.evaluateRBN(A_eps_04(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon04 = [0.4];
...
[r06, rb06, cE06, cands06, vt06] = nnv_net.evaluateRBN(A_eps_06(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon06 = [0.6];
...
[r08, rb08, cE08, cands08, vt08] = nnv_net.evaluateRBN(A_eps_08(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon08 = [0.8];
...
[r12, rb12, cE12, cands12, vt12] = nnv_net.evaluateRBN(A_eps_12(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon12 = [1.2];
...
[r14, rb14, cE14, cands14, vt14] = nnv_net.evaluateRBN(A_eps_14(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon14 = [1.4];
...
[r16, rb16, cE16, cands16, vt16] = nnv_net.evaluateRBN(A_eps_16(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon16 = [1.6];
...
[r18, rb18, cE18, cands18, vt18] = nnv_net.evaluateRBN(A_eps_18(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon18 = [1.8];
...
[r20, rb20, cE20, cands20, vt20] = nnv_net.evaluateRBN(A_eps_20(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon20 = [2.0];
