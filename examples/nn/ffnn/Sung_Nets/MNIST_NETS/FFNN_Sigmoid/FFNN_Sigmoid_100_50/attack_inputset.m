...
% save sigmoid_100_50_not_normalized/inputZono02.mat Z_eps_02
% 
% eps = 0.4
% for n = 1:N
%    IM = IM_data(:, n);
...
% save sigmoid_100_50_not_normalized/inputZono04.mat Z_eps_04
% 
% eps = 0.6
% for n = 1:N
%    IM = IM_data(:, n);
...
% save sigmoid_100_50_not_normalized/inputZono06.mat Z_eps_06
% 
% eps = 0.8
% for n = 1:N
%    IM = IM_data(:, n);
...
% save sigmoid_100_50_not_normalized/inputZono08.mat Z_eps_08
% 
% eps = 1.0
% for n = 1:N
%    IM = IM_data(:, n);
...
% save sigmoid_100_50_not_normalized/inputZono10.mat Z_eps_10
% 
% eps = 1.2
% for n = 1:N
%    IM = IM_data(:, n);
...
% save sigmoid_100_50_not_normalized/inputZono12.mat Z_eps_12
% 
% eps = 1.4
% for n = 1:N
%    IM = IM_data(:, n);
...
% save sigmoid_100_50_not_normalized/inputZono14.mat Z_eps_14
...
save sigmoid_100_50_not_normalized/inputZono16.mat Z_eps_16
...
save sigmoid_100_50_not_normalized/inputZono18.mat Z_eps_18
...
save sigmoid_100_50_not_normalized/inputZono20.mat Z_eps_20
...
save sigmoid_100_50_not_normalized/inputZono22.mat Z_eps_22
...
save sigmoid_100_50_not_normalized/inputZono24.mat Z_eps_24
...
save sigmoid_100_50_not_normalized/inputZono26.mat Z_eps_26
