...
% load normalized/inputRStar_norm022.mat;
% load normalized/inputRStar_norm024.mat;
% load normalized/inputRStar_norm026.mat;

load sigmoid_100_50_not_normalized/inputRStar_norm0001.mat;
load sigmoid_100_50_not_normalized/inputRStar_norm0002.mat;
load sigmoid_100_50_not_normalized/inputRStar_norm0003.mat;
load sigmoid_100_50_not_normalized/inputRStar_norm0004.mat;
load sigmoid_100_50_not_normalized/inputRStar_norm0005.mat;
load sigmoid_100_50_not_normalized/inputRStar_norm0006.mat;
load sigmoid_100_50_not_normalized/inputRStar_norm0007.mat;
load sigmoid_100_50_not_normalized/inputRStar_norm0008.mat;
load sigmoid_100_50_not_normalized/inputRStar_norm0009.mat;
load sigmoid_100_50_not_normalized/inputRStar_norm0010.mat;
% load normalized/inputRStar_norm0012.mat;
% load normalized/inputRStar_norm0014.mat;
% load normalized/inputRStar_norm0016.mat;
% load normalized/inputRStar_norm0018.mat;
% load normalized/inputRStar_norm0020.mat;
% load normalized/inputRStar_norm0022.mat;
% load normalized/inputRStar_norm0024.mat;
% load normalized/inputRStar_norm0026.mat;
% load normalized/inputRStar_norm0028.mat;
% load normalized/inputRStar_norm0030.mat;
...
save("verify_result/sigmoid_rstar_eps_0001_verify_norm.mat", 'T0001', 'r0001', 'rb0001', 'cE0001', 'cands0001', 'vt0001');
...
save("verify_result/sigmoid_rstar_eps_0002_verify_norm.mat", 'T0002', 'r0002', 'rb0002', 'cE0002', 'cands0002', 'vt0002');
...
save("verify_result/sigmoid_rstar_eps_0003_verify_norm.mat", 'T0003', 'r0003', 'rb0003', 'cE0003', 'cands0003', 'vt0003');
...
save("verify_result/sigmoid_rstar_eps_0004_verify_norm.mat", 'T0004', 'r0004', 'rb0004', 'cE0004', 'cands0004', 'vt0004');
...
save("verify_result/sigmoid_rstar_eps_0005_verify_norm.mat", 'T0005', 'r0005', 'rb0005', 'cE0005', 'cands0005', 'vt0005');
...
save("verify_result/sigmoid_rstar_eps_0006_verify_norm.mat", 'T0006', 'r0006', 'rb0006', 'cE0006', 'cands0006', 'vt0006');
...
save("verify_result/sigmoid_rstar_eps_0007_verify_norm.mat", 'T0007', 'r0007', 'rb0007', 'cE0007', 'cands0007', 'vt0007');
...
save("verify_result/sigmoid_rstar_eps_0008_verify_norm.mat", 'T0008', 'r0008', 'rb0008', 'cE0008', 'cands0008', 'vt0008');
...
save("verify_result/sigmoid_rstar_eps_0009_verify_norm.mat", 'T0009', 'r0009', 'rb0009', 'cE0009', 'cands0009', 'vt0009');
...
save("verify_result/sigmoid_rstar_eps_0010_verify_norm.mat", 'T0010', 'r0010', 'rb0010', 'cE0010', 'cands0010', 'vt0010');

% [r0012, rb0012, cE0012, cands0012, vt0012] = nnv_net.evaluateRBN(RS_eps_norm_0012(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
% epsilon0012 = [0.012];
...
% fprintf('total time rstar norm (eps=0.012): %f ',verify_time0012);
% save("verify_result/sigmoid_rrstar_eps_0012_verify_norm.mat", 'T0012', 'r0012', 'rb0012', 'cE0012', 'cands0012', 'vt0012');
% 
% [r0014, rb0014, cE0014, cands0014, vt0014] = nnv_net.evaluateRBN(RS_eps_norm_0014(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
% epsilon0014 = [0.014];
...
% fprintf('total time rstar norm (eps=0.014): %f ',verify_time0014);
% save("verify_result/sigmoid_rstar_eps_0014_verify_norm.mat", 'T0014', 'r0014', 'rb0014', 'cE0014', 'cands0014', 'vt0014');
% 
% [r0016, rb0016, cE0016, cands0016, vt0016] = nnv_net.evaluateRBN(RS_eps_norm_0016(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
% epsilon0016 = [0.016];
...
% fprintf('total time rrstar norm (eps=0.016): %f ',verify_time0016);
% save("verify_result/sigmoid_rstar_eps_0016_verify_norm.mat", 'T0016', 'r0016', 'rb0016', 'cE0016', 'cands0016', 'vt0016');
% 
% [r0018, rb0018, cE0018, cands0018, vt0018] = nnv_net.evaluateRBN(RS_eps_norm_0018(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
% epsilon0018 = [0.018];
...
% fprintf('total time rstar norm (eps=0.018): %f ',verify_time0018);
% save("verify_result/sigmoid_rstar_eps_0018_verify_norm.mat", 'T0018', 'r0018', 'rb0018', 'cE0018', 'cands0018', 'vt0018');
% 
% [r0020, rb0020, cE0020, cands0020, vt0020] = nnv_net.evaluateRBN(RS_eps_norm_0020(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
% epsilon0020 = [0.020];
...
% fprintf('total time rstar norm (eps=0.020): %f ',verify_time0020);
% save("verify_result/sigmoid_rstar_eps_0020_verify_norm.mat", 'T0020', 'r0020', 'rb0020', 'cE0020', 'cands0020', 'vt0020');
% 
% [r0022, rb0022, cE0022, cands0022, vt0022] = nnv_net.evaluateRBN(RS_eps_norm_0022(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
% epsilon0022 = [0.022];
...
% fprintf('total time rstar norm (eps=0.022): %f ',verify_time0022);
% save("verify_result/sigmoid_rstar_eps_0022_verify_norm.mat", 'T0022', 'r0022', 'rb0022', 'cE0022', 'cands0022', 'vt0022');
% 
% [r0024, rb0024, cE0024, cands0024, vt0024] = nnv_net.evaluateRBN(RS_eps_norm_0024(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
% epsilon0024 = [0.024];
...
% fprintf('total time rstar norm (eps=0.024): %f ',verify_time0024);
% save("verify_result/sigmoid_rstar_eps_24_verify_norm.mat", 'T0024', 'r0024', 'rb0024', 'cE0024', 'cands0024', 'vt0024');
% 
% [r0026, rb0026, cE0026, cands0026, vt0026] = nnv_net.evaluateRBN(RS_eps_0026(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
% epsilon0026 = [0.026];
...
% fprintf('total time rstar norm (eps=0.026): %f ',verify_time0026);
% save("verify_result/sigmoid_star_eps_0026_verify_norm.mat", 'T0026', 'r0026', 'rb0026', 'cE0026', 'cands0026', 'vt0026');
% 
% [r0028, rb0028, cE0028, cands0028, vt0028] = nnv_net.evaluateRBN(RS_eps_norm_0028(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
% epsilon0028 = [0.028];
...
% save("verify_result/sigmoid_rstar_eps_0028_verify_norm.mat", 'T0028', 'r0028', 'rb0028', 'cE0028', 'cands0028', 'vt0028');
% 
% [r0030, rb0030, cE0030, cands0030, vt0030] = nnv_net.evaluateRBN(RS_eps_norm_0030(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
% epsilon0030 = [0.030];
...
% fprintf('total time rstar norm (eps=0.030): %f ',verify_time0030);
% save("verify_result/sigmoid_rstar_eps_0030_verify_norm.mat", 'T0030', 'r0030', 'rb0030', 'cE0030', 'cands0030', 'vt0030');
...
% fprintf('total time rstar norm (eps=2.2): %f ',verify_time22);
% save("verify_result/sigmoid_rstar_eps_22_verify_norm.mat", 'T22', 'r22', 'rb22', 'cE22', 'cands22', 'vt22');
% 
...
% fprintf('total time rstar norm (eps=2.4): %f ',verify_time24);
% save("verify_result/sigmoid_rstar_eps_24_verify_norm.mat", 'T24', 'r24', 'rb24', 'cE24', 'cands24', 'vt24');
% 
...
% fprintf('total time rstar norm (eps=2.6): %f ',verify_time26);
% save("verify_result/sigmoid_rstar_eps_26_verify_norm.mat", 'T26', 'r26', 'rb26', 'cE26', 'cands26', 'vt26');
