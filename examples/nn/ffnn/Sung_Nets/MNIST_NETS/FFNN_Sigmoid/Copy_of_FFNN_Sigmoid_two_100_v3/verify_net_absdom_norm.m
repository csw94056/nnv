...
load normalized/inputAbsDom_norm0002.mat;
load normalized/inputAbsDom_norm0004.mat;
load normalized/inputAbsDom_norm0006.mat;
load normalized/inputAbsDom_norm0008.mat;
load normalized/inputAbsDom_norm0010.mat;
...
fprintf('total time absdom norm (eps=0.012): %f ',verify_time012);
...
[r0016, rb0016, cE0016, cands0016, vt0016] = nnv_net.evaluateRBN(A_eps_norm_016(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon0016 = [0.016];
...
[r0022, rb0022, cE0022, cands0022, vt0022] = nnv_net.evaluateRBN(A_eps_0022(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon0022 = [0.022];
...
[r0024, rb0024, cE0024, cands0024, vt0024] = nnv_net.evaluateRBN(A_eps_0024(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon0024 = [0.024];
...
[r0026, rb0026, cE0026, cands0026, vt0026] = nnv_net.evaluateRBN(A_eps_0026(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon0026 = [0.026];
