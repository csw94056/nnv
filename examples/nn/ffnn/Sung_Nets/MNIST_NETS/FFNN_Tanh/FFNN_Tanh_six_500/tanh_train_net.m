...
layers = [ 
	...
	fullyConnectedLayer(500,'WeightsInitializer', 'he', 'Name', 'dense_1')
    batchNormalizationLayer('Name','BN_1')
	tanhLayer('Name', 'tanh_1')
	
	fullyConnectedLayer(500,'WeightsInitializer', 'he', 'Name', 'dense_2')
    batchNormalizationLayer('Name','BN_2')
	tanhLayer('Name', 'tanh_2')
	
	fullyConnectedLayer(500,'WeightsInitializer', 'he', 'Name', 'dense_3')
    batchNormalizationLayer('Name','BN_3')
	tanhLayer('Name', 'tanh_3')
	
	fullyConnectedLayer(500,'WeightsInitializer', 'he', 'Name', 'dense_4')
    batchNormalizationLayer('Name','BN_4')
	tanhLayer('Name', 'tanh_4')
	
	fullyConnectedLayer(500,'WeightsInitializer', 'he', 'Name', 'dense_5')
    batchNormalizationLayer('Name','BN_5')
	tanhLayer('Name', 'tanh_5')
	
	fullyConnectedLayer(500,'WeightsInitializer', 'he', 'Name', 'dense_6')
