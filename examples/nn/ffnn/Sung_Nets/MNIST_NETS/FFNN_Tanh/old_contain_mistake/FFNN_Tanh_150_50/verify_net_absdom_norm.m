...
load normalized/inputAbsDom_norm001.mat A_eps_norm_001
load normalized/inputAbsDom_norm002.mat A_eps_norm_002 
load normalized/inputAbsDom_norm003.mat A_eps_norm_003 
load normalized/inputAbsDom_norm004.mat A_eps_norm_004 
load normalized/inputAbsDom_norm005.mat A_eps_norm_005 
load normalized/inputAbsDom_norm006.mat A_eps_norm_006 
load normalized/inputAbsDom_norm007.mat A_eps_norm_007 
load normalized/inputAbsDom_norm008.mat A_eps_norm_008 
load normalized/inputAbsDom_norm009.mat A_eps_norm_009 
...
for i = 1:50                                    % preview first 50 samples
    ...
    digit = reshape(A_eps_norm_005(i).lb{1}, [28,28]);     % row = 28 x 28 image
...
[r001, rb001, cE001, cands001, vt001] = nnv_net.evaluateRBN(A_eps_norm_001(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon001 = [0.001];
...
fprintf('total time absdom norm (eps=0.001): %f ',verify_time001);
save("tanh_absdom_eps_001_verify_norm.mat", 'T001', 'r001', 'rb001', 'cE001', 'cands001', 'vt001');
...
fprintf('total time absdom norm (eps=0.002): %f ',verify_time002);
save("tanh_absdom_eps_002_verify_norm.mat", 'T002', 'r002', 'rb002', 'cE002', 'cands002', 'vt002');


[r003, rb003, cE003, cands003, vt003] = nnv_net.evaluateRBN(A_eps_norm_003(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon003 = [0.003];
...
fprintf('total time absdom norm (eps=0.003): %f ',verify_time003);
save("tanh_absdom_eps_003_verify_norm.mat", 'T003', 'r003', 'rb003', 'cE003', 'cands003', 'vt003');
...
fprintf('total time absdom norm (eps=0.004): %f ',verify_time004);
save("tanh_absdom_eps_004_verify_norm.mat", 'T004', 'r004', 'rb004', 'cE004', 'cands004', 'vt004');
...
save("tanh_absdom_eps_005_verify_norm.mat", 'T005', 'r005', 'rb005', 'cE005', 'cands005', 'vt005');
...
fprintf('total time absdom norm (eps=0.006): %f ',verify_time006);
save("tanh_absdom_eps_006_verify_norm.mat", 'T006', 'r006', 'rb006', 'cE006', 'cands006', 'vt006');


[r007, rb007, cE007, cands007, vt007] = nnv_net.evaluateRBN(A_eps_norm_007(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon007 = [0.007];
...
fprintf('total time absdom norm (eps=0.007): %f ',verify_time007);
save("tanh_absdom_eps_007_verify_norm.mat", 'T007', 'r007', 'rb007', 'cE007', 'cands007', 'vt007');
...
fprintf('total time absdom norm (eps=0.008): %f ',verify_time008);
save("tanh_absdom_eps_008_verify_norm.mat", 'T008', 'r008', 'rb008', 'cE008', 'cands008', 'vt008');


[r009, rb009, cE009, cands009, vt009] = nnv_net.evaluateRBN(A_eps_norm_009(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon009 = [0.009];
...
fprintf('total time absdom norm (eps=0.009): %f ',verify_time009);
save("tanh_absdom_eps_009_verify_norm.mat", 'T009', 'r009', 'rb009', 'cE009', 'cands009', 'vt009');
...
save("tanh_absdom_eps_010_verify_norm.mat", 'T010', 'r010', 'rb010', 'cE010', 'cands010', 'vt010');
...
save("tanh_absdom_eps_015_verify_norm.mat", 'T015', 'r015', 'rb015', 'cE015', 'cands015', 'vt015');
...
save("tanh_absdom_eps_020_verify_norm.mat", 'T020', 'r020', 'rb020', 'cE020', 'cands020', 'vt020');
...
save("tanh_absdom_eps_025_verify_norm.mat", 'T025', 'r025', 'rb025', 'cE025', 'cands025', 'vt025');
...
save("tanh_absdom_eps_030_verify_norm.mat", 'T030', 'r030', 'rb030', 'cE030', 'cands030', 'vt030');
