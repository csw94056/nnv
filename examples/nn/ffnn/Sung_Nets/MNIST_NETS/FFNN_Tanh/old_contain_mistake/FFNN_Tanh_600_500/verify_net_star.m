...
% fprintf('total time star (eps=1): %f ',verify_time1);
...
% fprintf('total time star (eps=2): %f ',verify_time2);
...
% fprintf('total time star (eps=3): %f ',verify_time3);
...
% fprintf('total time star (eps=4): %f ',verify_time4);
...
% fprintf('total time star (eps=5): %f ',verify_time5);
