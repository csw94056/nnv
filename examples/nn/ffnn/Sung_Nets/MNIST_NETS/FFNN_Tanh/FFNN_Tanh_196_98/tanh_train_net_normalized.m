...
layers = [ 
	...
	fullyConnectedLayer(196,'WeightsInitializer', 'glorot', 'Name', 'dense_1')
	tanhLayer('Name', 'tanh_1')
	
	fullyConnectedLayer(98,'WeightsInitializer', 'glorot', 'Name', 'dense_2')
...
save MNIST_tanh_196_98_normalized_DenseNet.mat net;
