...
load normalized/inputStar_norm001.mat S_eps_norm_001
load normalized/inputStar_norm002.mat S_eps_norm_002 
load normalized/inputStar_norm003.mat S_eps_norm_003 
load normalized/inputStar_norm004.mat S_eps_norm_004 
load normalized/inputStar_norm005.mat S_eps_norm_005 
load normalized/inputStar_norm006.mat S_eps_norm_006 
load normalized/inputStar_norm007.mat S_eps_norm_007 
load normalized/inputStar_norm008.mat S_eps_norm_008 
load normalized/inputStar_norm009.mat S_eps_norm_009 
load normalized/inputStar_norm010.mat S_eps_norm_010 
load normalized/inputStar_norm015.mat S_eps_norm_015 
load normalized/inputStar_norm020.mat S_eps_norm_020 
load normalized/inputStar_norm025.mat S_eps_norm_025 
load normalized/inputStar_norm030.mat S_eps_norm_030

load MNIST_tanh_196_98_normalized_DenseNet.mat net;
...
% [r001, rb001, cE001, cands001, vt001] = nnv_net.evaluateRBN(S_eps_norm_001(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
% epsilon001 = [0.001];
...
% fprintf('total time star norm (eps=0.001): %f ',verify_time001);
% save("tanh_star_eps_001_verify_norm.mat", 'T001', 'r001', 'rb001', 'cE001', 'cands001', 'vt001');
...
% fprintf('total time star norm (eps=0.002): %f ',verify_time002);
% save("tanh_star_eps_002_verify_norm.mat", 'T002', 'r002', 'rb002', 'cE002', 'cands002', 'vt002');


[r003, rb003, cE003, cands003, vt003] = nnv_net.evaluateRBN(S_eps_norm_003(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon003 = [0.003];
...
fprintf('total time star norm (eps=0.003): %f ',verify_time003);
save("tanh_star_eps_003_verify_norm.mat", 'T003', 'r003', 'rb003', 'cE003', 'cands003', 'vt003');
...
fprintf('total time star norm (eps=0.004): %f ',verify_time004);
save("tanh_star_eps_004_verify_norm.mat", 'T004', 'r004', 'rb004', 'cE004', 'cands004', 'vt004');
...
fprintf('total time star norm (eps=0.006): %f ',verify_time006);
save("tanh_star_eps_006_verify_norm.mat", 'T006', 'r006', 'rb006', 'cE006', 'cands006', 'vt006');


[r007, rb007, cE007, cands007, vt007] = nnv_net.evaluateRBN(S_eps_norm_007(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon007 = [0.007];
...
fprintf('total time star norm (eps=0.007): %f ',verify_time007);
save("tanh_star_eps_007_verify_norm.mat", 'T007', 'r007', 'rb007', 'cE007', 'cands007', 'vt007');
...
save("tanh_star_eps_008_verify_norm.mat", 'T008', 'r008', 'rb008', 'cE008', 'cands008', 'vt008');


[r009, rb009, cE009, cands009, vt009] = nnv_net.evaluateRBN(S_eps_norm_009(1:N), labels(1:N)+1, reachMethod, numCores, 0, 0, 'glpk');
epsilon009 = [0.009];
...
fprintf('total time star norm (eps=0.009): %f ',verify_time009);
save("tanh_star_eps_009_verify_norm.mat", 'T009', 'r009', 'rb009', 'cE009', 'cands009', 'vt009');
