...
% load inputAbsDom_norm005.mat;
% load inputAbsDom_norm010.mat;
% load inputAbsDom_norm015.mat;
% load inputAbsDom_norm020.mat;
% load inputAbsDom_norm025.mat;
% load inputAbsDom_norm030.mat;

load tanh_100_100_normalized/inputAbsDom_norm0001.mat;
load tanh_100_100_normalized/inputAbsDom_norm0002.mat;
load tanh_100_100_normalized/inputAbsDom_norm0003.mat;
load tanh_100_100_normalized/inputAbsDom_norm0004.mat;
load tanh_100_100_normalized/inputAbsDom_norm0005.mat;
load tanh_100_100_normalized/inputAbsDom_norm0006.mat;
load tanh_100_100_normalized/inputAbsDom_norm0007.mat;
load tanh_100_100_normalized/inputAbsDom_norm0008.mat;
load tanh_100_100_normalized/inputAbsDom_norm0009.mat;
load tanh_100_100_normalized/inputAbsDom_norm0010.mat;
...
for i = 1:50                                    % preview first 50 samples
    ...
    digit = reshape(A_eps_norm_0001(i).lb{1}, [28,28]);     % row = 28 x 28 image
...
save("verify_result/tanh_absdom_eps_0001_verify_norm.mat", 'T0001', 'r0001', 'rb0001', 'cE0001', 'cands0001', 'vt0001');
...
save("verify_result/tanh_absdom_eps_0002_verify_norm.mat", 'T0002', 'r0002', 'rb0002', 'cE0002', 'cands0002', 'vt0002');
...
save("verify_result/tanh_absdom_eps_0003_verify_norm.mat", 'T0003', 'r0003', 'rb0003', 'cE0003', 'cands0003', 'vt0003');
...
save("verify_result/tanh_absdom_eps_0004_verify_norm.mat", 'T0004', 'r0004', 'rb0004', 'cE0004', 'cands0004', 'vt0004');
...
save("verify_result/tanh_absdom_eps_0005_verify_norm.mat", 'T0005', 'r0005', 'rb0005', 'cE0005', 'cands0005', 'vt0005');
...
save("verify_result/tanh_absdom_eps_0007_verify_norm.mat", 'T0007', 'r0007', 'rb0007', 'cE0007', 'cands0007', 'vt0007');
...
save("verify_result/tanh_absdom_eps_0008_verify_norm.mat", 'T0008', 'r0008', 'rb0008', 'cE0008', 'cands0008', 'vt0008');
...
save("verify_result/tanh_absdom_eps_0009_verify_norm.mat", 'T0009', 'r0009', 'rb0009', 'cE0009', 'cands0009', 'vt0009');
...
save("verify_result/tanh_absdom_eps_0010_verify_norm.mat", 'T0010', 'r0010', 'rb0010', 'cE0010', 'cands0010', 'vt0010');
