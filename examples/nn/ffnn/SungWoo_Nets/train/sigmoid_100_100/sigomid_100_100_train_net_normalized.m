...
% 
% save ../../MNIST/nets/sigmoid_100_100/MNIST_sigmoid_100_100_normalized_DenseNet.mat net;

load ../../MNIST/nets/sigmoid_100_100/MNIST_sigmoid_100_100_normalized_DenseNet.mat
predY = classify(net,testX)';
accuracy = sum(predY == testY)/length(testY)

N = 300; % get 100 images and its labels from the imdsValidation
IM_data = zeros(784, N);
IM_labels = zeros(N, 1);
...
writematrix(IM,'../../MNIST/data/sigmoid_100_100_raw.csv');
