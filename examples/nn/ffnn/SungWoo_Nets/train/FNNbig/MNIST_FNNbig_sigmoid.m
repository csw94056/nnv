...
save ../../MNIST/nets/FNNbig/MNIST_FNNbig_sigmoid.mat net;

% load ../../MNIST/nets/FNNbig/MNIST_FNNbig_sigmoid.mat;
% predY = classify(net,testX)';
% accuracy = sum(predY == testY)/length(testY)
...
writematrix(IM,'../../MNIST/data/MNIST_FNNbig_sigmoid_raw.csv');
