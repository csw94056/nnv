...
% 	
% 	fullyConnectedLayer(400,'WeightsInitializer', 'glorot', 'Name', 'dense_1')
% 	tanhLayer('Name', 'tanh_1')
% 	
% 	fullyConnectedLayer(400,'WeightsInitializer', 'glorot', 'Name', 'dense_2')
% 	tanhLayer('Name', 'tanh_2')
%     
%     fullyConnectedLayer(400,'WeightsInitializer', 'glorot', 'Name', 'dense_3')
% 	tanhLayer('Name', 'tanh_3')
% 	
% 	fullyConnectedLayer(400,'WeightsInitializer', 'glorot', 'Name', 'dense_4')
% 	tanhLayer('Name', 'tanh_4')
%     
% 	fullyConnectedLayer(10, 'WeightsInitializer', 'glorot', 'Name', 'dense_5')
...
% 
% save ../../MNIST/nets/FNNmed/MNIST_FNNmed_tanh.mat net;

load ../../MNIST/nets/FNNmbig/MNIST_FNNbig_tanh.mat net;
predY = classify(net,testX/255)';
confusion_matrix = confusionmat(testY, predY)
accuracy = sum(predY == testY)/length(testY)

N = 1000; % get 150 images and its labels from the imdsValidation
IM_data = zeros(784, N);
IM_labels = zeros(N, 1);
...
writematrix(IM,'../../MNIST/data/MNIST_FNNbig_tanh_raw.csv');
