...
N = 300; % get 150 images and its labels from the imdsValidation
IM_data = zeros(784, N);
IM_labels = zeros(N, 1);
...
writematrix(IM,'../../MNIST/data/tanh_100_100_raw.csv');
% save tanh_100_100_images.mat IM_data IM_labels
