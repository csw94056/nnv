...
% save ../../MNIST/nets/MNIST_tanh_100_100_normalized_DenseNet.mat net;

load ../../MNIST/nets/tanh_100_100/MNIST_tanh_100_100_normalized_DenseNet.mat
predY = classify(net,testX)';
accuracy = sum(predY == testY)/length(testY)

N = 300; % get 50 images and its labels from the imdsValidation
IM_data = zeros(784, N);
IM_labels = zeros(N, 1);
...
writematrix(IM,'../../MNIST/data/tanh_100_100_normalized_raw.csv');
% save tanh_100_100_images_normalized.mat IM_data IM_labels
