...
% save ../nets/FNNsmall/CIFAR10_FNNsmall_tanh.mat net;
%
% load ../../CIFAR10/nets/FNNsmall/CIFAR10_FNNsmall_tanh.mat;
% predY = classify(net,testX)';
% accuracy = sum(predY == testY)/length(testY)
...
% writematrix(IM,'../data/CIFAR10_FNNsmall_tanh_raw.csv');
