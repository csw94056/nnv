...
% save ../nets/FNNsmall/CIFAR10_FNNsmall_sigmoid.mat net;
% 
% load ../nets/FNNsmall/CIFAR10_FNNsmall_sigmoid.mat;
% predY = classify(net,testX);
% accuracy = sum(predY == testY)/length(testY)
...
% writematrix(IM,'../../CIFAR10/data/CIFAR10_FNNsmall_sigmoid_raw.csv');
