...
%     
% 	fullyConnectedLayer(10, 'Name', 'dense_5')
...
% 
% save ../nets/FNNbig/CIFAR10_FNNbig_sigmoid.mat net;

load ../nets/FNNbig/CIFAR10_FNNbig_sigmoid.mat;
predY = classify(net,testX);
confusion_matrix = confusionmat(testY, predY)
accuracy = sum(predY == testY)/length(testY)
...
writematrix(IM,'../../CIFAR10/data/CIFAR10_FNNbig_sigmoid_raw.csv');
