...
%                     end
        ...
        % affine abstract mapping of AbsDom set
        function R = affineMap(varargin)
            ...
            if mW ~= obj.dim
                error('Inconsistency between the affine mapping matrix and dimension of the AbsDom set');
            end
            ...
            R = AbsDom(lower_a, upper_a, lb, ub, obj.iter); 
        end
