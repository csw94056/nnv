classdef LayerS
    ...
    methods % reachability analysis method
        ...
        function S = reach(varargin)
            ...
            if ~strcmp(method, 'exact-star') && ~strcmp(method, 'approx-star') && ~strcmp(method, 'approx-star-fast') && ~strcmp(method, 'approx-zono') && ~strcmp(method, 'abs-dom') && ~strcmp(method, 'exact-polyhedron') && ~strcmp(method, 'approx-star-split') && ~strcmp(method,'approx-star-no-split') && ~strcmp(method, 'absdom') && ~strcmp(method, 'rstar-absdom-two') && ~strcmp(method, 'rstar-absdom-three')
